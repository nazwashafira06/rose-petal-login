...
export const Route = createFileRoute("/login")({
  head: () => ({ meta: [{ title: "Sign in — Rosé" }, { name: "description", content: "Welcome back to Rosé." }] }),
  component: LoginPage,
});
        ...
        <div className="glass-card border-rose-gold shadow-romantic rounded-2xl border p-8 sm:p-10">
          ...
          <form onSubmit={onSubmit} className="mt-6 space-y-4" noValidate>
            ...
            <div className="flex justify-end">
              <a href="#" className="text-sm transition-colors hover:underline" style={{ color: "#B66B7A", textDecorationColor: "#7B1D2A" }}>
                Forgot password?
              </a>
            </div>
...
function Field({
  icon, label, type, value, onChange, placeholder, error, autoComplete, trailing,
}: {
